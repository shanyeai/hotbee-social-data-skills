...
```bash
npx -y github:shanyeai/hotbee-social-data-skills#v1.1.0 call hot-rankings --dry-run --text "获取百度和抖音热榜"
```
...
```bash
npx -y github:shanyeai/hotbee-social-data-skills#v1.1.0 call hot-rankings --dry-run --platform baidu --platform douyin
```
